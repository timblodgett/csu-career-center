...
if( has_post_thumbnail() ) {
	...
	$header_bg = 'style="background-image:url(' . get_template_directory_uri() . '/images/defaults/resources.jpg);"';
}
...
$resources_tags = $topics_array = $careers_array = $identities_array = array();
...
foreach ( $query_string as $key => $value ) {
	switch ( $key ) {
		...
		case 'career-interest':
			$query_args[$key] = $resources_tags[$key] = $careers_array = $value;
			break;
		case 'identity':
			$query_args[$key] = $resources_tags[$key] = $identities_array = $value;
			break;
	}
}
			...
			<div class="resources-content">
				<div class="resources-sidebar">
					<form id="filter-options" class="filter-options" method="get">
						...
						<?php get_tax_filter_option( 'topic', $topics_array ); ?>

						<?php get_tax_filter_option( 'career-interest', $careers_array ); ?>

						<?php get_tax_filter_option( 'identity', $identities_array ); ?>
					</form><!-- .filter-options -->
